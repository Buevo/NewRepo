    ...
    <div class="container mt-4">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div>
                ...
                <a href="logout.aspx" class="btn btn-outline-secondary">Cerrar sesión</a>
            </div>
        </div>
            ...
            .then(data => {
                ...
                data.forEach(f => {
                    ...
                    const actions = $('<td>');
                        ...
                        actions.append(`<button class="btn btn-sm btn-outline-primary mr-1" onclick="downloadFile(${f.IdArchivo})">Descargar</button>`);
